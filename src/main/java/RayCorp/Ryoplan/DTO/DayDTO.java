...
public class DayDTO {
    ...
    private List<ActivitiesDTO> list_aktivitas;


    public DayDTO(){}
    public DayDTO(Long day_id, String day_title, String description, Integer day_counter, BigDecimal biaya_hotel, PlanShowDTO plan, List<ActivitiesDTO> list_aktivitas){
        this.day_id = day_id;
    ...
    public List<ActivitiesDTO> getList_aktivitas() {return list_aktivitas;}
    ...
    public void setList_aktivitas(List<ActivitiesDTO> list_aktivitas) {this.list_aktivitas = list_aktivitas;}
}
